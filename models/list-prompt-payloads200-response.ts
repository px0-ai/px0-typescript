 ...
 * 
 * @export
 * @interface ListPromptPayloads200Response
 */
export interface ListPromptPayloads200Response {
    /**
     * 
     * @type {Array<PromptPayload>}
     * @memberof ListPromptPayloads200Response
     */
    'payloads': Array<PromptPayload>;
}
